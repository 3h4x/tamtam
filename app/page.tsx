...
export default function Home() {
  const { tasks, loading, refreshing, fleet, issueCounts } = useProjects()
  ...
  if (tasks.length === 0) {
    return (
      <EmptyState
        ...
        description="TamTam scans your workspace directory for git repositories. Configure the workspace path in Settings, then enable the projects you want to track."
        action={
          <Link
            href="/settings"
