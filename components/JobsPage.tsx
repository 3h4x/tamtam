            ...
            {filtered.map((job) => {
              ...
              return (
                <tr
                  ...
                  onClick={() => router.push(job.kind === 'run' ? (job.session_id ? `/project/${job.project}/experimental/${job.session_id}` : `/project/${job.project}/experimental`) : `/project/${job.project}/jobs/${job.id}`)}
                >
