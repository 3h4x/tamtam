            ...
            {filtered.map((job) => {
              ...
              return (
                <tr
                  ...
                  onClick={() => router.push(job.kind === 'run' && job.session_id ? `/project/${projectName}/experimental/${job.session_id}` : `/project/${projectName}/experimental?job=${encodeURIComponent(job.id)}`)}
                >
