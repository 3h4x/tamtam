            ...
            {filtered.map((job) => {
              ...
              return (
                <tr
                  ...
                  onClick={() => router.push(job.kind === 'run' && job.session_id ? `/project/${projectName}/terminal/${job.session_id}` : `/project/${projectName}/terminal?job=${encodeURIComponent(job.id)}`)}
                >
