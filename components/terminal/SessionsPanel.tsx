  ...
  return (
    <div className="border-b border-border bg-bg-secondary shrink-0">
      {loadingSessions ? (
        ...
        (() => {
          // Hoist `now` so every session in this render computes its
          // relative age against the same instant — otherwise two
          // sessions one second apart could render the same `timeAgo`
          // (or different ones, depending on map timing).
