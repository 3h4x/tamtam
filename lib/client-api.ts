...
export async function createAgent(agent: { name: string; project: string; skillIds: string[]; docPaths?: string[]; model: string; prompt?: string; schedule?: string | null; runner?: string; enabled?: boolean }): Promise<{ agent: Agent }> {
...
export async function updateAgent(agentId: string, updates: Partial<{ name: string; skillIds: string[]; docPaths: string[]; model: string; prompt: string; schedule: string | null; runner: string; enabled: boolean }>): Promise<{ agent: Agent }> {
