...
function renderConfigTab(overrides: Partial<React.ComponentProps<typeof ConfigTab>> = {}) {
  const props: React.ComponentProps<typeof ConfigTab> = {
    ...
    setDevServerStartCommandInput: vi.fn(),
    devServerStopCommandInput: '',
    setDevServerStopCommandInput: vi.fn(),
    devServerReadyUrlInput: '',
    setDevServerReadyUrlInput: vi.fn(),
    dailySpendCapUsdInput: '',
    setDailySpendCapUsdInput: vi.fn(),
    releaseSpendCapUsdInput: '',
    setReleaseSpendCapUsdInput: vi.fn(),
    editActions: [],
