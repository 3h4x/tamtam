...
- `/project/[name]` — Project overview; `/project/[name]/[tab]` — tabs (`overview`, `config`, `history`, `terminal`, `changes`, `issues`, `docs`)
